 ...
 * C `struct` contains a shared pointer to C++ `class`, [Wrap by C++ Shared Pointer](#wrap-by-c-shared-pointer)
 * C `struct` contains a instance of C++ `class`, [Wrap by C++ Object](#wrap-by-c-object)
 * C `struct` rewrite the C++ `class`, [Wrap by Rewrite](#wrap-by-rewrite)
