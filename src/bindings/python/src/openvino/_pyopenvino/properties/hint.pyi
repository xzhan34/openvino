...
def activations_scale_factor() -> str:
    ...
@typing.overload
def activations_scale_factor(arg0: typing.SupportsFloat | typing.SupportsIndex) -> tuple[str, openvino._pyopenvino.OVAny]:
    ...
@typing.overload
...
def dynamic_quantization_group_size() -> str:
    ...
@typing.overload
def dynamic_quantization_group_size(arg0: typing.SupportsInt | typing.SupportsIndex) -> tuple[str, openvino._pyopenvino.OVAny]:
    ...
@typing.overload
...
def num_requests() -> str:
    ...
@typing.overload
def num_requests(arg0: typing.SupportsInt | typing.SupportsIndex) -> tuple[str, openvino._pyopenvino.OVAny]:
    ...
@typing.overload
