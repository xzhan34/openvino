...
MOE3GemmFusedCompressed::MOE3GemmFusedCompressed(const OutputVector& args, const ov::op::internal::MOECompressed::Config& config)
    : ov::op::internal::MOECompressed(args, config) {
    constructor_validate_and_infer_types();
}

void MOE3GemmFusedCompressed::validate_and_infer_types() {
    OV_OP_SCOPE(internal_MOE3GemmFusedCompressed_validate_and_infer_types);
