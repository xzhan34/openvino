...
OV_CONFIG_RELEASE_OPTION(ov::hint, attn_kernel_mode, ov::hint::AttnKernelMode::AUTO, "Attention kernel implementation mode. AUTO lets the device choose; PA_CM requests the CM paged attention kernel.")
