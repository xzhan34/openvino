...
struct FusedConvRef : public ImplementationManager {
    OV_GPU_PRIMITIVE_IMPL("ocl::fused_conv::ref")
    explicit FusedConvRef(shape_types shape_type, ValidateFunc vf = nullptr) : ImplementationManager(impl_types::ocl, shape_type, std::move(vf)) {}
