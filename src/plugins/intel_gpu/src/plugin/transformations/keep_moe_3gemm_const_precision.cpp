...
KeepMOE3GemmConstPrecision::KeepMOE3GemmConstPrecision() {
    ...
    auto moe_softmax_shared_m = wrap_type<ov::op::internal::MOE3GemmFusedCompressed>(
    ...
    auto moe_sigmoid_shared_m = wrap_type<ov::op::internal::MOE3GemmFusedCompressed>(
        {any_input(), any_input(), wei_0_m, any_input(), zp_0_m, wei_1_m, any_input(), zp_1_m, wei_2_m, any_input(),
         zp_2_m, any_input(), any_input(), sh_gate_wei_m, any_input(), sh_gate_zp_m, sh_up_wei_m, any_input(), sh_up_zp_m, sh_down_wei_m, any_input(), sh_down_zp_m, any_input()});
    ...
    ov::matcher_pass_callback callback = [OV_CAPTURE_CPY_AND_THIS](ov::pass::pattern::Matcher& m) {
        ...
        auto moe_3gemm_fused_compressed = ov::as_type_ptr<ov::op::internal::MOE3GemmFusedCompressed>(m.get_match_root());
